                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        ...
                                        <ul class="contact-infor mb-50">
                                            ...
                                            <li><img src="assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Contact Seller:</strong><span>@if($product->vendor_id == NULL)
                                        ...
                                        <p>@if($product->vendor_id == NULL)
                                            <span>Owner Short Details</span>
                                            
                                            @else
                                            <span>{{$product['vendor']['vendor_short_info']}}</span>
                                            @endif</span></p>
                                    </div>
